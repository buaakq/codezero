...
#define OMAP3_MCSPI1_BASE		0x48030000		//REVISIT   changed Struct mcspi
#define OMAP3_MCSPI2_BASE		0x481A0000		//REVISIT   changed Struct mcspi

#define OMAP3_MCSPI_MAX_FREQ		48000000		//REVISIT
...
static inline struct winbond_spi_flash *to_winbond_spi_flash(
		struct spi_flash *flash) {
	return container_of(flash, struct winbond_spi_flash, flash);
}

static inline struct stmicro_spi_flash *to_stmicro_spi_flash(
		struct spi_flash *flash) {
